export const finances = {
    accounts: [
        { id: '1', title: 'Bill Quantity',  isPiggy: false, created_at: '20-02-2024'},
        { id: '2', title: 'Bill Quantity',  isPiggy: true, created_at: '20-02-2024'},
        { id: '3', title: 'Bill Quantity',  isPiggy: false, created_at: '20-02-2024'}
    ],
    transactions: [
